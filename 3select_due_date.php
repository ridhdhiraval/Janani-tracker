...
<body class="bg-bg-light flex flex-col items-center p-5 text-text-dark">
    ...
    <div class="w-full max-w-sm text-center mt-12">
        ...
        <div id="date-selection-card" class="bg-white p-6 rounded-xl shadow-lg border border-pink-100">
    ...
    <script>
        ...
        function handleDueSubmission() {
            ...
            window.location.href = `4congratulations.php?due_date=${selectedDate}`;
        }
    </script>
