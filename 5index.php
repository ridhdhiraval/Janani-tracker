...
// --- 2. Application Data (Static for Mockup) ---
$appData = [
    'week_number' => 1,
    'days_to_go' => 279,
    'percent_done' => 0.4, 
    'checklist_percent' => 100, // Text for the circle
    'progress_width' => 0, // Progress bar width (0% for Week 1)
];
    ...
    <div class="app-container">
        ...
        <script>
            ...
            const ICON_SVGS = {
                ...
                alert:'<img width="40" height="40" src="https://img.icons8.com/pastel-glyph/64/d81b60/siren.png" alt="siren"/>',
                ...
                mail: '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.83 1.83 0 0 1-2.06 0L2 7"/></svg>',
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                document.getElementById('mail-icon').innerHTML = getIcon('mail');
...
<div class="top-bar">
    ...
    <div style="display: flex; gap: 10px;">
        ...
        <a href="9mail.php?lang=<?php echo $current_lang; ?>" class="icon-link" title="<?php echo t('mail_title'); ?>">
        ...
        <div class="week-tracker">
            <div class="week-circle-container">
                <div class="stat-left">
                    <strong id="percent-done"><?php echo ($appData['percent_done'] * 100) . '%'; ?></strong> 
                    <?php echo t('complete'); ?>
                </div>
                <div class="week-circle">
                    <?php echo t('week'); ?>
                    <div class="week-number" id="week-number"><?php echo $appData['week_number']; ?></div>
                    <div class="week-days" id="week-days"><?php echo $appData['days_to_go']; ?> <?php echo t('days_to_go_small'); ?></div>
                </div>
                <div class="stat-right">
                    <strong id="days-left"><?php echo $appData['days_to_go']; ?></strong> 
                    <?php echo t('days_to_go_caps'); ?>
                </div>
            </div>
            <a href="10trimster.php?lang=<?php echo $current_lang; ?>" class="trimester"><?php echo t('trimester'); ?></a>
        </div>
        ...
        <div class="main-content-wrapper">
            <div class="main-content">
                ...
                <div class="action-card" onclick="location.href='fruit_details.php?lang=<?php echo $current_lang; ?>'">
                    ...
                    <span class="card-illustration" id="card-illustration"></span>
                </div>
