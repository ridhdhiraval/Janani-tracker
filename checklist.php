...
// 'category' helps in filtering/grouping.
// 'completed' is the status (1 for checked, 0 for unchecked).

$checklist_data = [
    // Trimester 1 (Weeks 1-12)
    [ 'id' => 1, 'category' => 'Trimester 1: Health', 'task' => 'Book first prenatal appointment', 'completed' => 1 ],
    [ 'id' => 2, 'category' => 'Trimester 1: Health', 'task' => 'Start taking prenatal vitamins (Folic Acid)', 'completed' => 1 ],
    [ 'id' => 3, 'category' => 'Trimester 1: Essentials', 'task' => 'Calculate due date and confirm with doctor', 'completed' => 0 ],
    [ 'id' => 4, 'category' => 'Trimester 1: Planning', 'task' => 'Research hospital/birth center options', 'completed' => 0 ],
    
    // Trimester 2 (Weeks 13-27)
    [ 'id' => 5, 'category' => 'Trimester 2: Health', 'task' => 'Schedule the mid-pregnancy ultrasound (Anomaly Scan)', 'completed' => 0 ],
    [ 'id' => 6, 'category' => 'Trimester 2: Essentials', 'task' => 'Start looking for maternity clothes', 'completed' => 0 ],
    [ 'id' => 7, 'category' => 'Trimester 2: Planning', 'task' => 'Begin compiling the baby registry', 'completed' => 0 ],
    [ 'id' => 8, 'category' => 'Trimester 2: Planning', 'task' => 'Decide on baby names', 'completed' => 0 ],
    
    // Trimester 3 (Weeks 28-40)
    [ 'id' => 9, 'category' => 'Trimester 3: Preparation', 'task' => 'Attend prenatal/lamaze classes', 'completed' => 0 ],
    [ 'id' => 10, 'category' => 'Trimester 3: Preparation', 'task' => 'Pack the hospital bag for mom and baby', 'completed' => 0 ],
    [ 'id' => 11, 'category' => 'Trimester 3: Preparation', 'task' => 'Install and check the car seat', 'completed' => 0 ],
    [ 'id' => 12, 'category' => 'Trimester 3: Essentials', 'task' => 'Wash all baby clothes and bedding', 'completed' => 0 ],
];

// PHP Logic to calculate progress
